...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/home/john/x-tools/mips64el-loongson3a-linux-gnu/mips64el-loongson3a-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
